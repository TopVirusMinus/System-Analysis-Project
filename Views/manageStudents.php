...
<table border=2px>
    ...
    <?php
        ...
        {
            echo '<tr><td>'.$studentsObjArray[$i]->getId().'</td>.<td>'.$studentsObjArray[$i]->getName().'</td><td>'.$studentsObjArray[$i]->getEmail().'</td><td>'.$studentsObjArray[$i]->getGrade().'</td><td><a href="../Functions/addCourseToStudent.php?studentId='.$studentsObjArray[$i]->getId().'&teacherId='.$_SESSION["U-record"][0].'">Add</a></td></td></tr>';
        }
        ?>
</table>
